...
public class ChipsAdapter extends RecyclerView.Adapter<ChipsAdapter.ChipsVH> {
    ...
    public ChipsAdapter(Context context, ArrayList<String> list, ChipsClick chipsClick) {
    ...
    public ChipsVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ChipsVH(LayoutInflater.from(context).inflate(R.layout.chips, parent, false));
    }
